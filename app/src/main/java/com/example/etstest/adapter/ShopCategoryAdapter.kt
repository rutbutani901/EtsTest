...
class ShopView(val binding: ItemShopBinding):
    RecyclerView.ViewHolder(binding.root)

class ShopCategoryAdapter (val context: Context, val firstList : List<ShopModel>,
                        val callback:(position: Int)->Unit): RecyclerView.Adapter<ShopView>() {
